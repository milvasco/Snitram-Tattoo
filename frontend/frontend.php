...
<div class="login-form">
    <form action="recebe_login.php" method="post">
        ...
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Email" name="mail" value= "<?php if(isset($_COOKIE['mail'])){ echo $_COOKIE['mail']; }; ?>" required="required">
        </div>
        <div class="form-group">
	...
	<p class="text-center"><a href="/pap vasco/pap.php">Home</a></p>
</div>
